...
const Navbar =({homeref,aboutRef,skillsRef,projectsref,contactRef})=>{
    ...
    <Center>
        <Spacer/>
        <Box position="fixed"  width ="100%" opacity="0.90"  bgColor="#011029"  paddingRight="30px" paddingTop="10px" paddingBottom="10px" marginTop="30px" border="2px solid #2d2d2b" >
    <Flex justify="right" >
    ...
    <ButtonGroup gap='3' >
     ...
     <Button size='lg'className="nav-link skills" _hover={{bgColor:"#0e2d2a"}} colorScheme="teal" color="#79d392" variant="ghost"  onClick={() => scrollToComponent(skillsRef)}>Skills</Button>
      ...
      <Button size='lg' className="nav-link contact" _hover={{bgColor:"#0e2d2a"}} colorScheme="teal" color="#79d392" variant="ghost" onClick={() => scrollToComponent(contactRef)} >Contact</Button>
        <a href="https://drive.google.com/file/d/1kssfizjn1TMiIspINAPijMKaMuN1eCFS/view?usp=sharing" target="_blank"><Button id="resume-button-1"  className="nav-link resume" size='sm' _hover={{bgColor:"#79f099"}}marginTop="5px"   leftIcon={<DownloadIcon />} >Resume</Button></a>
    </ButtonGroup>
